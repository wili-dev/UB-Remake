...
hook OnPlayerClickPlayerTextDraw(playerid, PlayerText:playertextid) {
    ...
    if (!IsPlayerLogged(playerid)) {
        ...
        if (playertextid == TxdRegisterButtonRegister[playerid][1]) {
            ...
            if (GetPlayerBirthDate(playerid) != '\0' || GetPlayerGender(playerid) != '\0' || GetPlayerEmail(playerid) != '\0'
...
VSL_CreateTextdrawsRegister(playerid) {
    ...
    TxdRegisterButtonRegister[playerid][1] = CreatePlayerTextDraw(playerid, 282.000000, 379.000000, "Fazer Login");
